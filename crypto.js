...
function noChacha() { throw new Error('chacha is not included!') }
var chachaHelper = { encrypt: noChacha, decrypt: noChacha }
...
function useChacha(chacha) {
  chachaHelper = chacha;
}

exports.transform = transform;
exports.crypto = cryptoInit;
exports.useChacha = useChacha;
